...
describe('DataSourcePicker', () => {
  ...
  describe('onClear', () => {
    it('should call onClear when function is passed', async () => {
      ...
      const select = render(<DataSourcePicker current={null} onChange={jest.fn()} onClear={onClear} />);
    ...
    it('should not render clear button when no onClear function is passed', async () => {
      const select = render(<DataSourcePicker current={null} onChange={jest.fn()} />);
    ...
    it('should pass disabled prop', async () => {
      render(<DataSourcePicker current={null} onChange={jest.fn()} disabled={true} />);
