...
// isolation (single test in ~33s) but individual tests exceed the 90s budget
// under parallel CPU contention. 180s matches the policy used by the rest of
// the Category B alerting flakes (NotificationPoliciesPage,
// PolicyTreeSelector.integration).
