...
import { Alert, DataSourceHttpSettings, Field, FieldSet, Select, Switch, useStyles2 } from '@grafana/ui';
...
export const ConfigEditor = (props: Props) => {
  ...
  const [showMappingsHelp, setShowMappingsHelp] = useState<boolean>(() =>
    store.getObject(SHOW_MAPPINGS_HELP_KEY, true)
  );
  ...
  return (
    <>
      ...
      />
      <FieldSet>
        <legend className={styles.pageHeading}>Graphite details</legend>
        <Field
          label="Version"
